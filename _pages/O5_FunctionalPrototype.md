...
<table style="width:100%; border-collapse: collapse; font-size: 0.95em; margin: 1.5em 0;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">200×75×10mm bounding box; PLA; tooth at end for scraping</td>
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">N/A</td>
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">3D printed in RPL using PLA</td>
    ...
    <tr>
      ...
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">¼" wall thickness, chemical resistant, 1.125in OD, 3ft length</td>
    ...
    <tr>
      ...
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">15×36×130mm bounding box; PLA; string tied to it for jaw actuation</td>
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">N/A</td>
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">3D printed in RPL using PLA</td>
    ...
    <tr>
      ...
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">127×50×38mm bounding box; PLA; attaches via M6 bolt; padded</td>
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">N/A</td>
      <td style="padding: 9px 12px; border-bottom: 1px solid #dee2e6;">3D printed in RPL using PLA</td>
...
<div style="display:flex; gap:16px; flex-wrap:wrap; margin:1.5em 0;"><figure style="flex:1; min-width:220px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f1-jawclosed.jpg" alt="Bucket and Jaw Side View Closed" style="width:100%; height:260px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 1: Bucket and Jaw Side View Closed</strong></figcaption></figure><figure style="flex:1; min-width:220px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f2-jawopen.jpg" alt="Bucket and Jaw Side View Open" style="width:100%; height:260px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 2: Bucket and Jaw Side View Open</strong></figcaption></figure></div>

<div style="display:flex; gap:16px; flex-wrap:wrap; margin:1.5em 0;"><figure style="flex:1; min-width:220px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f3-jawinside.jpg" alt="Inside Bucket with Jaw Springs" style="width:100%; height:260px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 3: Inside Bucket with Jaw Springs</strong></figcaption></figure><figure style="flex:1; min-width:220px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f4-jawoverall.jpg" alt="Overall Bucket and Jaw with String Attached" style="width:100%; height:260px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 4: Overall Bucket and Jaw with String Attached</strong></figcaption></figure></div>

After feedback on our mock-up prototype, we designed a 3D-printed shoulder stock attachment to the other end of the PVC pipe and attached padding on the end to further reduce user discomfort.

<div style="display:flex; gap:16px; flex-wrap:wrap; margin:1.5em 0;"><figure style="flex:1; min-width:180px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f5-shoulderrear.jpg" alt="Shoulder Stock Rear View" style="width:100%; height:300px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 5: Shoulder Stock Rear View</strong></figcaption></figure><figure style="flex:1; min-width:180px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f6-shoulderside.jpg" alt="Shoulder Stock Side View" style="width:100%; height:300px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 6: Shoulder Stock Side View</strong></figcaption></figure></div>
...
<div style="display:flex; gap:16px; flex-wrap:wrap; margin:1.5em 0;"><figure style="flex:1; min-width:160px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f7-handleside.jpg" alt="Handle-Trigger Side Profile" style="width:100%; height:240px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 7: Handle-Trigger Side Profile</strong></figcaption></figure><figure style="flex:1; min-width:160px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f8-handleback.jpg" alt="Handle Back Profile and Trigger Guide Rails" style="width:100%; height:240px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 8: Handle Back Profile and Trigger Guide Rails</strong></figcaption></figure><figure style="flex:1; min-width:160px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f9-handleassembly.jpg" alt="Handle-Trigger Assembly" style="width:100%; height:240px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 9: Handle-Trigger Assembly</strong></figcaption></figure></div>
...
<div style="text-align:center; margin:1.5em 0;"><img src="/trevor_crouse/assets/images/f10-entirecad.jpg" alt="Entire CAD Prototype" style="max-width:85%; height:auto;"><p style="margin-top:6px; font-size:0.9em;"><em><strong>Figure 10: Entire CAD Prototype</strong></em></p></div>
...
<div style="text-align:center; margin:1.5em 0;"><img src="/trevor_crouse/assets/images/f11-shoulderattached.jpg" alt="Shoulder Stock Attached" style="max-width:40%; height:auto;"><p style="margin-top:6px; font-size:0.9em;"><em><strong>Figure 11: Shoulder Stock Attached</strong></em></p></div>
...
<div style="display:flex; gap:16px; flex-wrap:wrap; margin:1.5em 0;"><figure style="flex:1; min-width:160px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f12-slidinghandle.jpg" alt="Sliding on Handle" style="width:100%; height:240px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 12: Sliding on Handle</strong></figcaption></figure><figure style="flex:1; min-width:160px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f13-nutthroughhandle.jpg" alt="Running String Through Handle" style="width:100%; height:240px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 13: Running String Through Handle</strong></figcaption></figure><figure style="flex:1; min-width:160px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f14-handlebolted.jpg" alt="Trigger and Handle Assembled and Bolted" style="width:100%; height:240px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 14: Trigger and Handle Assembled and Bolted</strong></figcaption></figure></div>

Following this, we drilled a hole to bolt the bucket-jaw assembly to the pipe, as well as a hole before that attachment at the top of the pipe to allow the string to exit the inside of the pipe and move towards its guide ramp on the bucket for actuation.

<div style="display:flex; gap:16px; flex-wrap:wrap; margin:1.5em 0;"><figure style="flex:1; min-width:220px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f15-pipeintobucket.jpg" alt="Inserting Pipe to Bucket" style="width:100%; height:260px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 15: Inserting Pipe to Bucket</strong></figcaption></figure><figure style="flex:1; min-width:220px; margin:0; text-align:center;"><img src="/trevor_crouse/assets/images/f16-attachedjaw.jpg" alt="Attached Bucket-Jaw Assembly" style="width:100%; height:260px; object-fit:contain;"><figcaption style="margin-top:6px; font-size:0.9em;"><strong>Figure 16: Attached Bucket-Jaw Assembly</strong></figcaption></figure></div>
...
<div style="text-align:center; margin:1.5em 0;"><img src="/trevor_crouse/assets/images/f17-bucketjawassembly.jpg" alt="Bucket-Jaw Assembly" style="max-width:40%; height:auto;"><p style="margin-top:6px; font-size:0.9em;"><em><strong>Figure 17: Bucket-Jaw Assembly</strong></em></p></div>

This concludes the assembly process. Below is an image of the functional prototype as built in the lab.

<div style="text-align:center; margin:1.5em 0;"><img src="/trevor_crouse/assets/images/f18-finaloperatingposition.jpg" alt="Final Assembled Prototype in Operating Position" style="max-width:85%; height:auto;"><p style="margin-top:6px; font-size:0.9em;"><em><strong>Figure 18: Final Assembled Prototype in Operating Position</strong></em></p></div>
...
**Testing:** Scraping/hinging force of the jaw when attached to bucket, and durability over 100 cycles.

**How to Perform:** Using a spring scale, measure the output force of the jaw mechanism and the opening gap at rest. Then cycle the actuating system 100 times and measure again.
...
**How to Perform:** Images of a group member using the prototype were taken in three positions — upward, straight ahead, and downward. RULA (Rapid Upper Limb Assessment) was completed using CUErgo (1), with client feedback used to estimate time spent in each position.
