---
layout: default
title: 2250 Mechanical Design Project
permalink: /2250-Mechanical-Design-Project/
---
...
The spotted lanternfly poses a significant threat to vineyards. Existing removal methods offer no reliable way to verify destruction or quantify success. Our team designed and built the **BuzzKill Jaw Bucket** — a trigger-actuated, shoulder-mounted tool that scrapes and collects egg masses into a sealed bucket, enabling growers to count and confirm removal.

The project spanned the full design cycle from client brief to functional prototype, with structured deliverables at each stage.
