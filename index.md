...
Take a look at <a href="{{ "/projects/" | relative_url }}">my projects</a> and <a href="{{ '/assets/Crouse_Trevor_Resume.pdf' | relative_url }}" target="_blank">Resume</a> and <a href="{{ "/O3_ClientOutlineTemplate/" | relative_url }}">2250 Client Outreach</a>
.
